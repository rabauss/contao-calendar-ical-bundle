...
$GLOBALS['TL_LANG']['tl_calendar_events']['correctTimezone'] = array('Correct time zone', 'Choose this option to correct the time zone of the import file and assign the current time zone of this Contao installation instead.');
