...
$GLOBALS['TL_LANG']['CTE']['ical'] = ['iCal', 'This element contains a hyperlink to an vCalendar (iCal) which can be downloaded and used to display calendar dates in an external calendar application.'];
